...
def get_templates_menu() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="Список шаблонов", callback_data="templates_view")],
...
def get_template_detail_keyboard(template_id: int, is_active: bool = True) -> InlineKeyboardMarkup:
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="Изменить текст", callback_data=f"template_edit_text_{template_id}")],
    ]

    if is_active:
        buttons.append([InlineKeyboardButton(text="Отключить шаблон", callback_data=f"template_disable_{template_id}")])
    else:
        buttons.append([InlineKeyboardButton(text="Включить шаблон", callback_data=f"template_enable_{template_id}")])

    buttons.append([InlineKeyboardButton(text="Назад", callback_data="templates_view")])
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def get_template_confirmation_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Подтвердить", callback_data="template_confirm")],
            [InlineKeyboardButton(text="Отмена", callback_data="templates_list")],
        ]
    )
...
def get_template_edit_menu(template_id: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Изменить название", callback_data=f"template_edit_name_{template_id}")],
            [InlineKeyboardButton(text="Изменить текст", callback_data=f"template_edit_text_{template_id}")],
            [InlineKeyboardButton(text="Назад", callback_data=f"template_detail_{template_id}")],
        ]
    )
...
def get_template_edit_confirmation_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="Сохранить", callback_data="template_save_changes")],
            [InlineKeyboardButton(text="Отмена", callback_data="template_cancel_edit")],
        ]
    )
